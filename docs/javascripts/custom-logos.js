...
document$.subscribe(() => {
  ...
  if (path.includes("/projects/rover")) {
    if (!document.getElementById("rover-logos")) {
      ...
      roverContainer.innerHTML = `
        <img src="../../assets/images/projects/rover/logo1.png" width="120" style="margin:0.5rem;">
        <img src="../../assets/images/projects/rover/logo2.png" width="120" style="margin:0.5rem;">
        <br>
        <a href="https://discord.slugbotics.com" target="_blank" class="join-button" style="border-radius: 8px; display: inline-block; text-align: center; margin-top: 1rem;">
          Join Our Discord
        </a>
      `;
  ...
  if (!document.getElementById("global-slugbotics-logo")) {
    ...
    globalContainer.innerHTML = `
      ...
      <br>
      <a href="https://discord.slugbotics.com" target="_blank" class="join-button" style="border-radius: 8px; display: inline-block; text-align: center;">
        Join Our Discord
      </a>
    `;
